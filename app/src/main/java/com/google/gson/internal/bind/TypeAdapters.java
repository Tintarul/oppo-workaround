...
public final class TypeAdapters {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C048236 {
    ...
    static {
            ...
            */
            public BitSet read(JsonReader jsonReader) {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    int i2 = C048236.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                    boolean z = true;
                    if (i2 != 1) {
                        if (i2 == 2) {
        ...
        TypeAdapter<Number> typeAdapter7 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Number read(JsonReader jsonReader) {
                JsonToken peek = jsonReader.peek();
                int i = C048236.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                if (i != 1) {
                    if (i == 4) {
                        jsonReader.nextNull();
                        return null;
        ...
        TypeAdapter<JsonElement> typeAdapter18 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.29
            ...
            public JsonElement read(JsonReader jsonReader) {
                switch (C048236.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
