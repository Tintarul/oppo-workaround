...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if ("fragment".equals(str)) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0251R.styleable.Fragment);
            if (attributeValue == null) {
                attributeValue = obtainStyledAttributes.getString(C0251R.styleable.Fragment_android_name);
            }
            int resourceId = obtainStyledAttributes.getResourceId(C0251R.styleable.Fragment_android_id, -1);
            String string = obtainStyledAttributes.getString(C0251R.styleable.Fragment_android_tag);
