...
public class FragmentTransition {
    ...
    */
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, FragmentTransaction.C0307Op c0307Op, SparseArray<FragmentContainerTransition> sparseArray, boolean z, boolean z2) {
        int i;
        boolean z3;
        boolean z4;
        boolean z5;
        ...
        int i2 = z ? INVERSE_OPS[c0307Op.mCmd] : c0307Op.mCmd;
        boolean z6 = false;
        boolean z7 = true;
        if (i2 != 1) {
            if (i2 != 3) {
