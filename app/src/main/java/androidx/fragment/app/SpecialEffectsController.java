...
import androidx.fragment.C0251R;
...
public abstract class SpecialEffectsController {
    ...
    public static /* synthetic */ class C03263 {
        ...
        static {
            ...
            try {
                f120xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f120xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f121xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f121xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f121xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
    ...
    public static class Operation {
        ...
        final void mergeWith(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact) {
            int i = C03263.f120xb9e640f0[lifecycleImpact.ordinal()];
            if (i == 1) {
        ...
        public enum State {
            ...
            public void applyState(@NonNull View view) {
                int i = C03263.f121xe493b431[ordinal()];
                if (i == 1) {
    ...
    public static SpecialEffectsController getOrCreateController(@NonNull ViewGroup viewGroup, @NonNull SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        int i = C0251R.C0254id.special_effects_controller_view_tag;
