...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(@NonNull ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        HashSet hashSet = new HashSet();
        while (i < i2) {
            Iterator<FragmentTransaction.C0307Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
    ...
    */
    private void executeOpsTogether(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        if (!z3 && this.mCurState >= 1) {
                ...
                if (USE_STATE_MANAGER) {
                    ...
                    for (int i11 = i; i11 < i2; i11++) {
                        ...
                        if (booleanValue) {
                            ...
                            Iterator<FragmentTransaction.C0307Op> it = backStackRecord2.mOps.iterator();
                            while (it.hasNext()) {
            ...
            for (int i12 = i; i12 < i2; i12++) {
                Iterator<FragmentTransaction.C0307Op> it2 = arrayList.get(i12).mOps.iterator();
                while (it2.hasNext()) {
    ...
    public static Fragment getViewFragment(@NonNull View view) {
        Object tag = view.getTag(C0251R.C0254id.fragment_container_view_tag);
