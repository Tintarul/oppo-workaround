...
public abstract class FragmentTransaction {
    ...
    /* loaded from: classes.dex */
    public static final class C0307Op {
        int mCmd;
        ...
        public C0307Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0307Op(int i, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    public void addOp(C0307Op c0307Op) {
        this.mOps.add(c0307Op);
        c0307Op.mEnterAnim = this.mEnterAnim;
        c0307Op.mExitAnim = this.mExitAnim;
        c0307Op.mPopEnterAnim = this.mPopEnterAnim;
        c0307Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        addOp(new C0307Op(10, fragment, state));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0307Op(8, fragment));
        return this;
    }
