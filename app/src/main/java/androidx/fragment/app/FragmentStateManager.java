...
public class FragmentStateManager {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C03052 {
    ...
    public int computeExpectedState() {
        ...
        int i2 = C03052.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment2.mMaxState.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                i = Math.min(i, 5);
            } else if (i2 == 3) {
    ...
    public void createView() {
        ...
        if (view != null) {
            ...
            Fragment fragment5 = this.mFragment;
            fragment5.mView.setTag(C0251R.C0254id.fragment_container_view_tag, fragment5);
            if (viewGroup != null) {
                addViewToContainer();
            }
    ...
    public void ensureInflatedView() {
        ...
        if (fragment.mFromLayout && fragment.mInLayout && !fragment.mPerformedCreateView) {
            ...
            if (view != null) {
                view.setSaveFromParentEnabled(false);
                Fragment fragment3 = this.mFragment;
                fragment3.mView.setTag(C0251R.C0254id.fragment_container_view_tag, fragment3);
                Fragment fragment4 = this.mFragment;
