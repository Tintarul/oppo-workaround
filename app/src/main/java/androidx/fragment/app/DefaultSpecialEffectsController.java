...
public class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    static /* synthetic */ class C025710 {
        ...
        static {
            ...
            try {
                f119xe493b431[SpecialEffectsController.Operation.State.INVISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f119xe493b431[SpecialEffectsController.Operation.State.REMOVED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f119xe493b431[SpecialEffectsController.Operation.State.VISIBLE.ordinal()] = 4;
                    ...
                    endViewTransitionAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.4
                        ...
                        public void onAnimationEnd(Animation animation3) {
                            container.post(new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.4.1
                                ...
                                public void run() {
                                    animationAnimation$AnimationListenerC02604 animationanimation_animationlistenerc02604 = animationAnimation$AnimationListenerC02604.this;
    ...
    void executeOperations(@NonNull List<SpecialEffectsController.Operation> list, boolean z) {
        ...
        for (SpecialEffectsController.Operation operation3 : list) {
            ...
            int i = C025710.f119xe493b431[operation3.getFinalState().ordinal()];
            if (i != 1 && i != 2 && i != 3) {
