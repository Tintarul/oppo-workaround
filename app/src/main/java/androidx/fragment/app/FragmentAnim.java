...
public class FragmentAnim {
                ...
                public void onAnimationEnd(Animation animation) {
                    viewGroup.post(new Runnable() { // from class: androidx.fragment.app.FragmentAnim.2.1
                        ...
                        public void run() {
                            if (fragment.getAnimatingAway() != null) {
                                fragment.setAnimatingAway(null);
                                animationAnimation$AnimationListenerC02852 animationanimation_animationlistenerc02852 = animationAnimation$AnimationListenerC02852.this;
    ...
    public static AnimationOrAnimator loadAnimation(@NonNull Context context, @NonNull Fragment fragment, boolean z, boolean z2) {
        ...
        if (viewGroup != null) {
            int i = C0251R.C0254id.visible_removing_fragment_view_tag;
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0251R.animator.fragment_open_enter : C0251R.animator.fragment_open_exit;
        } else if (i == 4099) {
            return z ? C0251R.animator.fragment_fade_enter : C0251R.animator.fragment_fade_exit;
        } else if (i != 8194) {
            return -1;
        } else {
            return z ? C0251R.animator.fragment_close_enter : C0251R.animator.fragment_close_exit;
        }
    }
