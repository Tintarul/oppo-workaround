...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            @NonNull
            /* renamed from: clone */
            public WearableExtender m289clone() {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(@Nullable Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0132R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0132R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int min;
            boolean z2 = true;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0132R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0132R.C0135id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0132R.C0135id.actions, generateActionButton(nonContextualActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0132R.C0135id.actions, i2);
            applyStandardTemplate.setViewVisibility(C0132R.C0135id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0132R.layout.notification_action_tombstone;
            } else {
                i = C0132R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0132R.C0135id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0132R.C0133color.notification_action_color_filter)));
            }
            remoteViews.setTextViewText(C0132R.C0135id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0132R.C0135id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0132R.C0135id.action_container, action.title);
            }
            return remoteViews;
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0132R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0132R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0132R.C0134drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0132R.C0135id.title, 8);
            remoteViews.setViewVisibility(C0132R.C0135id.text2, 8);
            remoteViews.setViewVisibility(C0132R.C0135id.text, 8);
        }
        ...
        /* JADX WARN: Removed duplicated region for block: B:158:0x0189 A[ADDED_TO_REGION] */
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            boolean z7 = true;
            boolean z8 = this.mBuilder.getPriority() < -1;
            int i2 = Build.VERSION.SDK_INT;
            if (i2 >= 16 && i2 < 21) {
                if (z8) {
                    remoteViews.setInt(C0132R.C0135id.notification_background, "setBackgroundResource", C0132R.C0134drawable.notification_bg_low);
                    remoteViews.setInt(C0132R.C0135id.icon, "setBackgroundResource", C0132R.C0134drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0132R.C0135id.notification_background, "setBackgroundResource", C0132R.C0134drawable.notification_bg);
                    remoteViews.setInt(C0132R.C0135id.icon, "setBackgroundResource", C0132R.C0134drawable.notification_template_icon_bg);
                }
            }
            Builder builder = this.mBuilder;
            if (builder.mLargeIcon != null) {
                if (i2 >= 16) {
                    int i3 = C0132R.C0135id.icon;
                    remoteViews.setViewVisibility(i3, 0);
                    remoteViews.setImageViewBitmap(i3, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0132R.C0135id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0132R.dimen.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0132R.dimen.notification_small_icon_background_padding) * 2);
                    if (i2 >= 21) {
                        Builder builder2 = this.mBuilder;
                        remoteViews.setImageViewBitmap(C0132R.C0135id.right_icon, createIconWithBackground(builder2.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, builder2.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0132R.C0135id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0132R.C0135id.right_icon, 0);
                }
            } else if (z && builder.mNotification.icon != 0) {
                int i4 = C0132R.C0135id.icon;
                remoteViews.setViewVisibility(i4, 0);
                if (i2 >= 21) {
                    int dimensionPixelSize3 = resources.getDimensionPixelSize(C0132R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0132R.dimen.notification_big_circle_margin);
                    int dimensionPixelSize4 = resources.getDimensionPixelSize(C0132R.dimen.notification_small_icon_size_as_large);
                    ...
                    remoteViews.setImageViewBitmap(i4, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            CharSequence charSequence3 = this.mBuilder.mContentTitle;
            if (charSequence3 != null) {
                remoteViews.setTextViewText(C0132R.C0135id.title, charSequence3);
            }
            CharSequence charSequence4 = this.mBuilder.mContentText;
            if (charSequence4 != null) {
                remoteViews.setTextViewText(C0132R.C0135id.text, charSequence4);
                z3 = true;
            } else {
                z3 = false;
            }
            boolean z9 = i2 < 21 && this.mBuilder.mLargeIcon != null;
            Builder builder4 = this.mBuilder;
            CharSequence charSequence5 = builder4.mContentInfo;
            if (charSequence5 != null) {
                int i5 = C0132R.C0135id.info;
                remoteViews.setTextViewText(i5, charSequence5);
                remoteViews.setViewVisibility(i5, 0);
            } else if (builder4.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0132R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0132R.C0135id.info, resources.getString(C0132R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0132R.C0135id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0132R.C0135id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0132R.C0135id.info, 8);
                z4 = z3;
                z5 = z9;
                charSequence = this.mBuilder.mSubText;
                if (charSequence != null && i2 >= 16) {
                    remoteViews.setTextViewText(C0132R.C0135id.text, charSequence);
                    charSequence2 = this.mBuilder.mContentText;
                    if (charSequence2 == null) {
                        int i6 = C0132R.C0135id.text2;
                        remoteViews.setTextViewText(i6, charSequence2);
                        remoteViews.setViewVisibility(i6, 0);
                        z6 = true;
                        if (z6 && i2 >= 16) {
                            if (z2) {
                                remoteViews.setTextViewTextSize(C0132R.C0135id.text, 0, resources.getDimensionPixelSize(C0132R.dimen.notification_subtext_size));
                            }
                            remoteViews.setViewPadding(C0132R.C0135id.line1, 0, 0, 0, 0);
                        }
                        if (this.mBuilder.getWhenIfShowing() == 0) {
                            z7 = z5;
                        } else if (this.mBuilder.mUseChronometer && i2 >= 16) {
                            int i7 = C0132R.C0135id.chronometer;
                            remoteViews.setViewVisibility(i7, 0);
                            remoteViews.setLong(i7, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            remoteViews.setBoolean(i7, "setStarted", true);
                            boolean z10 = this.mBuilder.mChronometerCountDown;
                            if (z10 && i2 >= 24) {
                                remoteViews.setChronometerCountDown(i7, z10);
                            }
                        } else {
                            int i8 = C0132R.C0135id.time;
                            remoteViews.setViewVisibility(i8, 0);
                            remoteViews.setLong(i8, "setTime", this.mBuilder.getWhenIfShowing());
                        }
                        remoteViews.setViewVisibility(C0132R.C0135id.right_side, z7 ? 0 : 8);
                        remoteViews.setViewVisibility(C0132R.C0135id.line3, z4 ? 0 : 8);
                        return remoteViews;
                    }
                    remoteViews.setViewVisibility(C0132R.C0135id.text2, 8);
                }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            int i = C0132R.C0135id.notification_main_column;
            remoteViews.removeAllViews(i);
            remoteViews.addView(i, remoteViews2.clone());
            remoteViews.setViewVisibility(i, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0132R.C0135id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        @NonNull
        /* renamed from: clone */
        public WearableExtender m290clone() {
            WearableExtender wearableExtender = new WearableExtender();
