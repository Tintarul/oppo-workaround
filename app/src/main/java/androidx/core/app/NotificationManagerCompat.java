...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            iNotificationSideChannel.notify(this.packageName, this.f27id, this.tag, this.notif);
        }

        @NonNull
        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f27id + ", tag:" + this.tag + "]";
        }
    }
    ...
    public static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f26id, this.tag);
            }
        }

        @NonNull
        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f26id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
