...
public final class LocationRequestCompat {
    ...
    @IntRange(from = 1, m267to = 2147483647L)
    public int getMaxUpdates() {
        return this.mMaxUpdates;
    }

    @FloatRange(from = 0.0d, m268to = 3.4028234663852886E38d)
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setMaxUpdates(@IntRange(from = 1, m267to = 2147483647L) int i) {
            this.mMaxUpdates = Preconditions.checkArgumentInRange(i, 1, Integer.MAX_VALUE, "maxUpdates");
            return this;
        }

        @NonNull
        public Builder setMinUpdateDistanceMeters(@FloatRange(from = 0.0d, m268to = 3.4028234663852886E38d) float f) {
            this.mMinUpdateDistanceMeters = f;
