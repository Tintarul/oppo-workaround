...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        public static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(final View view, WindowInsets windowInsets) {
                ...
                Impl21.dispatchOnPrepare(view, windowInsetsAnimationCompat, windowInsets, WindowInsetsAnimationCompat.DEBUG);
        ...
        static WindowInsets forwardToViewIfNeeded(@NonNull View view, @NonNull WindowInsets windowInsets) {
            return view.getTag(C0132R.C0135id.tag_on_apply_window_listener) != null ? windowInsets : view.onApplyWindowInsets(windowInsets);
        }

        @Nullable
        static Callback getCallback(View view) {
            Object tag = view.getTag(C0132R.C0135id.tag_window_insets_animation_callback);
        ...
        static void setCallback(@NonNull View view, @Nullable Callback callback) {
            Object tag = view.getTag(C0132R.C0135id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0132R.C0135id.tag_window_insets_animation_callback, null);
                if (tag == null) {
            ...
            view.setTag(C0132R.C0135id.tag_window_insets_animation_callback, createProxyListener);
            if (tag == null) {
    ...
    public void setAlpha(@FloatRange(from = 0.0d, m268to = 1.0d) float f) {
        this.mImpl.setAlpha(f);
    }

    public void setFraction(@FloatRange(from = 0.0d, m268to = 1.0d) float f) {
