...
public class AccessibilityDelegateCompat {
    ...
    static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> list = (List) view.getTag(C0132R.C0135id.tag_accessibility_actions);
    ...
    private boolean performClickableSpanAction(int i, View view) {
        ...
        SparseArray sparseArray = (SparseArray) view.getTag(C0132R.C0135id.tag_accessibility_clickable_spans);
    ...
    public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        return (z || i != C0132R.C0135id.accessibility_action_clickable_span) ? z : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
