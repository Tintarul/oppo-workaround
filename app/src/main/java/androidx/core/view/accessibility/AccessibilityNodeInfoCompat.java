...
public class AccessibilityNodeInfoCompat {
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        if (spansFromViewTags == null) {
            ...
            view.setTag(C0132R.C0135id.tag_accessibility_clickable_spans, sparseArray);
            return sparseArray;
        }
    ...
    private SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(C0132R.C0135id.tag_accessibility_clickable_spans);
    }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        ...
        getExtras().putInt(SPANS_ACTION_ID_KEY, C0132R.C0135id.accessibility_action_clickable_span);
