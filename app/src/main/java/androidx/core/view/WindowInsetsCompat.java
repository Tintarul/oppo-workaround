...
public class WindowInsetsCompat {
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            WindowInsetsCompat build = new Builder().setStableInsets(Insets.m263of(rect)).setSystemWindowInsets(Insets.m263of(rect2)).build();
    ...
    public static class Impl20 extends Impl {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 1) {
                if (z) {
                    return Insets.m264of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0);
                }
                return Insets.m264of(0, getSystemWindowInsets().top, 0, 0);
            }
            if (i == 2) {
                if (z) {
                    Insets rootStableInsets = getRootStableInsets();
                    Insets stableInsets2 = getStableInsets();
                    return Insets.m264of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m264of(systemWindowInsets.left, 0, systemWindowInsets.right, i3);
            } else if (i != 8) {
                if (i != 16) {
                    if (i != 32) {
                        if (i != 64) {
                            ...
                            if (displayCutout != null) {
                                return Insets.m264of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom());
                            }
                            return Insets.NONE;
                        }
        ...
        final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m264of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (max == i && max2 == i2 && max3 == i3 && max4 == i4) ? insets : Insets.m264of(max, max2, max3, max4);
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m264of(i, i2, i3, i4)).build();
    }
    ...
    public static class Impl21 extends Impl20 {
        ...
        final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m264of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(@NonNull Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m263of(rect)).build();
    }
