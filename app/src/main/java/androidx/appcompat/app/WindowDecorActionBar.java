...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0022R.C0025id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0022R.C0025id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0022R.C0025id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(C0022R.C0025id.action_bar_container);
        ...
        if (decorToolbar != null && this.mContextView != null && actionBarContainer != null) {
            ...
            TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0022R.styleable.ActionBar, C0022R.attr.actionBarStyle, 0);
            if (obtainStyledAttributes.getBoolean(C0022R.styleable.ActionBar_hideOnContentScroll, false)) {
                setHideOnContentScrollEnabled(true);
            }
            int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0022R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0022R.attr.actionBarWidgetTheme, typedValue, true);
