...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0022R.styleable.PopupWindow, i, i2);
        int i3 = C0022R.styleable.PopupWindow_overlapAnchor;
        if (obtainStyledAttributes.hasValue(i3)) {
            setSupportOverlapAnchor(obtainStyledAttributes.getBoolean(i3, false));
        }
        setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0022R.styleable.PopupWindow_android_popupBackground));
