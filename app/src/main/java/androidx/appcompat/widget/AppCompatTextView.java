...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatTextView> {
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            this.mAutoSizeMaxTextSizeId = propertyMapper.mapInt("autoSizeMaxTextSize", C0022R.attr.autoSizeMaxTextSize);
            this.mAutoSizeMinTextSizeId = propertyMapper.mapInt("autoSizeMinTextSize", C0022R.attr.autoSizeMinTextSize);
            this.mAutoSizeStepGranularityId = propertyMapper.mapInt("autoSizeStepGranularity", C0022R.attr.autoSizeStepGranularity);
            this.mAutoSizeTextTypeId = propertyMapper.mapIntEnum("autoSizeTextType", C0022R.attr.autoSizeTextType, new IntFunction<String>() { // from class: androidx.appcompat.widget.AppCompatTextView.InspectionCompanion.1
            ...
            this.mDrawableTintId = propertyMapper.mapObject("drawableTint", C0022R.attr.drawableTint);
            this.mDrawableTintModeId = propertyMapper.mapObject("drawableTintMode", C0022R.attr.drawableTintMode);
    ...
    @Override // android.widget.TextView
    public void setFirstBaselineToTopHeight(@IntRange(from = 0) @InterfaceC0020Px int i) {
    ...
    @Override // android.widget.TextView
    public void setLastBaselineToBottomHeight(@IntRange(from = 0) @InterfaceC0020Px int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    @Override // android.widget.TextView
    public void setLineHeight(@IntRange(from = 0) @InterfaceC0020Px int i) {
