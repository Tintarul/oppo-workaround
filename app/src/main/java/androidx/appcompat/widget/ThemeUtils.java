...
public class ThemeUtils {
    ...
    public static void checkAppCompatTheme(@NonNull View view, @NonNull Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(C0022R.styleable.AppCompatTheme);
        try {
            if (!obtainStyledAttributes.hasValue(C0022R.styleable.AppCompatTheme_windowActionBar)) {
