...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabView extends LinearLayout {
        ...
        */
        public TabView(Context context, ActionBar.Tab tab, boolean z) {
            ...
            ScrollingTabContainerView.this = r5;
            int i = C0022R.attr.actionBarTabStyle;
            int[] iArr = {16842964};
            this.BG_ATTRS = iArr;
            this.mTab = tab;
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0022R.attr.actionBarTabTextStyle);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0022R.attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0022R.attr.actionBarTabBarStyle);
