...
public class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0022R.styleable.AppCompatTextView;
        ...
        int i2 = C0022R.styleable.AppCompatTextView_autoSizeTextType;
        if (obtainStyledAttributes.hasValue(i2)) {
            this.mAutoSizeTextType = obtainStyledAttributes.getInt(i2, 0);
        }
        int i3 = C0022R.styleable.AppCompatTextView_autoSizeStepGranularity;
        ...
        int i4 = C0022R.styleable.AppCompatTextView_autoSizeMinTextSize;
        ...
        int i5 = C0022R.styleable.AppCompatTextView_autoSizeMaxTextSize;
        ...
        int i6 = C0022R.styleable.AppCompatTextView_autoSizePresetSizes;
