...
public class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0022R.styleable.ViewBackgroundHelper;
        ...
        try {
            int i2 = C0022R.styleable.ViewBackgroundHelper_android_background;
            ...
            int i3 = C0022R.styleable.ViewBackgroundHelper_backgroundTint;
            if (obtainStyledAttributes.hasValue(i3)) {
                ViewCompat.setBackgroundTintList(this.mView, obtainStyledAttributes.getColorStateList(i3));
            }
            int i4 = C0022R.styleable.ViewBackgroundHelper_backgroundTintMode;
