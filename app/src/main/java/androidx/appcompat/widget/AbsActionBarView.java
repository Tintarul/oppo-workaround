...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0022R.styleable.ActionBar, C0022R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0022R.styleable.ActionBar_height, 0));
    ...
    public AbsActionBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0022R.attr.actionBarPopupTheme, typedValue, true) && typedValue.resourceId != 0) {
