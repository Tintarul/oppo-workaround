...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView, TintableImageSourceView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatImageButton> {
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            ...
            this.mTintId = propertyMapper.mapObject("tint", C0022R.attr.tint);
            this.mTintModeId = propertyMapper.mapObject("tintMode", C0022R.attr.tintMode);
    ...
    public AppCompatImageButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0022R.attr.imageButtonStyle);
    }
