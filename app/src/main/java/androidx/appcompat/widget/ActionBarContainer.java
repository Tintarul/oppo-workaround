...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0022R.C0025id.action_bar);
        this.mContextView = findViewById(C0022R.C0025id.action_context_bar);
    }
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0022R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0022R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0022R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0022R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0022R.C0025id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0022R.styleable.ActionBar_backgroundSplit);
        }
