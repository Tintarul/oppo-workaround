...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0022R.attr.actionBarSize, 16842841};
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.mOverlayMode && !z) {
            ...
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.m264of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + measuredHeight, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0)).build();
        } else {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0022R.C0025id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0022R.C0025id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0022R.C0025id.action_bar));
        }
    }
