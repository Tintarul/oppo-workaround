...
class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0022R.styleable.AppCompatSeekBar;
        ...
        Drawable drawableIfKnown = obtainStyledAttributes.getDrawableIfKnown(C0022R.styleable.AppCompatSeekBar_android_thumb);
        if (drawableIfKnown != null) {
            this.mView.setThumb(drawableIfKnown);
        }
        setTickMark(obtainStyledAttributes.getDrawable(C0022R.styleable.AppCompatSeekBar_tickMark));
        int i2 = C0022R.styleable.AppCompatSeekBar_tickMarkTintMode;
        ...
        int i3 = C0022R.styleable.AppCompatSeekBar_tickMarkTint;
