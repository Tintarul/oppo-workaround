...
public class StateListDrawable extends DrawableContainer {
    ...
    private void inflateChildElements(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (true) {
            ...
            if (next2 == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0058R.styleable.StateListDrawableItem);
                int resourceId = obtainAttributes.getResourceId(C0058R.styleable.StateListDrawableItem_android_drawable, -1);
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        stateListState.mVariablePadding = typedArray.getBoolean(C0058R.styleable.StateListDrawable_android_variablePadding, stateListState.mVariablePadding);
        stateListState.mConstantSize = typedArray.getBoolean(C0058R.styleable.StateListDrawable_android_constantSize, stateListState.mConstantSize);
        stateListState.mEnterFadeDuration = typedArray.getInt(C0058R.styleable.StateListDrawable_android_enterFadeDuration, stateListState.mEnterFadeDuration);
        stateListState.mExitFadeDuration = typedArray.getInt(C0058R.styleable.StateListDrawable_android_exitFadeDuration, stateListState.mExitFadeDuration);
        stateListState.mDither = typedArray.getBoolean(C0058R.styleable.StateListDrawable_android_dither, stateListState.mDither);
    }
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0058R.styleable.StateListDrawable);
        setVisible(obtainAttributes.getBoolean(C0058R.styleable.StateListDrawable_android_visible, true), true);
